                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        ...
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-06.jpg') }}"
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-07.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                class="post-header panel vstack justify-between gap-1 w-100">
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">The
                                                                        Art of Baking: From Classic Bread to Artisan
                                                                        Pastries</a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-08.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                class="post-header panel vstack justify-between gap-1 w-100">
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">AI
                                                                        and Marketing: Unlocking Customer Insights</a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                                    <div>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-09.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-01.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-02.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                class="post-header panel vstack justify-between gap-1 w-100">
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">Tech
                                                                        Innovations Reshaping the Retail Landscape: AI
                                                                        Payments</a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-03.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-04.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-11.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                class="post-header panel vstack justify-between gap-1 w-100">
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">Solo
                                                                        Travel: Some Tips and Destinations for the
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-12.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-13.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                ...
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">Tech
                                                                        Tools for your Time Management: Enhancing
                                                                        Productivity</a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-14.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                            ...
                                                            <div
                                                                class="post-header panel vstack justify-between gap-1 w-100">
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none" href="blog-details.html">A
                                                                        Guide to The Rise of Gourmet Street Food: Trends
                                                                        and Top Picks</a>
                                                                </h3>
                                                                <div
                                                                    class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-10.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                                        ...
                                                        <article
                                                            ...
                                                            <div
                                                                ...
                                                                <figure
                                                                    ...
                                                                    <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                        src="{{ url('site/assets/images/common/img-fallback.png') }}"
                                                                        data-src="{{ url('site/assets/images/demo-eight/posts/img-05.jpg') }}"
                                                                        alt="image" data-uc-img="loading: lazy">
                                                                    <a href="blog-details.html" class="position-cover"
                                                                        data-caption="image"></a>
                                                                </figure>
                                    ...
                                    <div class="row child-cols col-match g-2">
                                        <div>
                                            <article
                                                ...
                                                <div class="post-header panel vstack justify-between gap-1 w-100">
                                                    <h3 class="post-title h6 m-0 text-truncate-2">
                                                        <a class="text-none" href="blog-details.html">The Rise of
                                                            AI-Powered Personal Assistants: How They Manage</a>
                                                    </h3>
                                                    <div
                                                        class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        <div>
                                        ...
                                        <div>
                                            <article
                                                ...
                                                <div class="post-header panel vstack justify-between gap-1 w-100">
                                                    <h3 class="post-title h6 m-0 text-truncate-2">
                                                        <a class="text-none" href="blog-details.html">Tech Innovations
                                        ...
                                        <div>
                                            <article
                                                ...
                                                <div class="post-header panel vstack justify-between gap-1 w-100">
                                                    <h3 class="post-title h6 m-0 text-truncate-2">
                                                        <a class="text-none" href="blog-details.html">The Importance
                                                            of Sleep: Tips for Better Rest and Recovery</a>
                                                    </h3>
                                                    <div
                                                        class="post-meta panel hstack gap-2 fs-7 fw-normal text-black dark:text-white text-opacity-60">
                                                        <div>
